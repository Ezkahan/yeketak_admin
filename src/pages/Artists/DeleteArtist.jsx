...
import { deleteArtist } from "api/services/ArtistService";

const DeleteArtist = ({ artist, artistDeleteHandler }) => {
  const artistDelete = () => {
    deleteArtist(artist.slug)
      .then((res) => {
        artistDeleteHandler(null);
        console.log(res);
      })
      .catch((err) => {
        console.log(err);
  ...
  return (
    <main className="flex flex-col justify-between h-full font-montserrat-medium">
      ...
      <footer className="flex items-center justify-between">
        ...
        <button
          onClick={() => artistDeleteHandler(null)}
